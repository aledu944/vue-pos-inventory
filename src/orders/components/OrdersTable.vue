...
<template>
    <section class="overflow-x-scroll">
        <div class="bg-white py-8 px-6 rounded-md border border-gray-300 w-full min-w-3xl">
            ...
            <p v-show="orderStore.orders.length === 0" class="text-center font-semibold text-gray-500">No se encontraron ventas</p>
            
            <!-- <div v-for="product in productsStore.products" :key="product.id"
                class="grid items-center grid-cols-9 text-sm gap-[2rem]">
